...
pub enum MetaFederation {
    ...
    /// FEDELEPO, but with international results also.
    #[strum(to_string = "fedelepo")]
    FEDELEPO,
    ...
    /// POSK, but with international results also.
    #[strum(to_string = "posk")]
    POSK,
    ...
    /// TTPF, but with international results also.
    #[strum(to_string = "ttpf")]
    TTPF,
...
impl MetaFederation {
    ...
    pub fn contains(self, entry: &Entry, meets: &[Meet]) -> bool {
        ...
        match self {
            ...
            MetaFederation::FEDELEPO => affiliation!(meet, entry, FEDELEPO, IPF, FESUPO, NAPF),
