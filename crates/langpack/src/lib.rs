...
pub struct CountryTranslations {
    ...
    pub faroeislands: &'static str,
    pub fiji: &'static str,
    pub finland: &'static str,
    pub france: &'static str,
    pub frenchpolynesia: &'static str,
...
impl Translations {
    ...
    pub fn translate_country(&self, country: Country) -> &str {
        match country {
            ...
            Country::Bermuda => self.country.bermuda,
