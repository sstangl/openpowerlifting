...
pub enum Federation {
    ...
    /// Unaffiliated meets held in France.
    #[serde(rename = "France-UA")]
    #[strum(to_string = "France-UA", serialize = "france-ua")]
    FranceUA,
    ...
    /// New Zealand Powerlifting United, WPUnited
    #[strum(to_string = "NZPU", serialize = "nzpu")]
    NZPU,
    ...
    /// World Powerlifting Lanka
    #[serde(rename = "WP-Lanka")]
    #[strum(to_string = "WP-Lanka", serialize = "wp-lanka")]
    WPLanka,
    ...
    /// World Power Power League, Kazakhstan.
    #[serde(rename = "WPPL-Kazakhstan")]
    #[strum(to_string = "WPPL-Kazakhstan", serialize = "wppl-kazakhstan")]
    WPPLKazakhstan,
    ...
    #[strum(to_string = "WRPF-DE", serialize = "wrpf-de")]
    WRPFDE,

    /// European WRPF.
    #[serde(rename = "WRPF-Europe")]
    #[strum(to_string = "WRPF-Europe", serialize = "wrpf-europe")]
    WRPFEurope,

    /// Honduran WRPF affiliate.
    #[serde(rename = "WRPF-HON")]
    #[strum(to_string = "WRPF-HON", serialize = "wrpf-hon")]
    WRPFHON,
    ...
    /// Indian WRPF affiliate.
    #[serde(rename = "WRPF-India")]
    #[strum(to_string = "WRPF-India", serialize = "wrpf-india")]
    WRPFIndia,
    ...
    #[strum(to_string = "WRPF-Latam", serialize = "wrpf-latam")]
    WRPFLatam,
    ...
    #[serde(rename = "WRPF-Serbia")]
    #[strum(to_string = "WRPF-Serbia", serialize = "wrpf-serbia")]
    WRPFSerbia,
...
impl Federation {
    ...
    pub fn is_fully_tested(self, date: Date) -> bool {
        ...
        match self {
            ...
            Federation::WPLanka => FULLY_TESTED,
            ...
            Federation::WPPLKazakhstan => false,
    ...
    pub fn home_country(self) -> Option<Country> {
        match self {
            ...
            Federation::NZPU => Some(Country::NewZealand),
            ...
            Federation::WPLanka => Some(Country::SriLanka),
            ...
            Federation::WPPLKazakhstan => Some(Country::Kazakhstan),
            ...
            Federation::WRPFIndia => Some(Country::India),
            ...
            Federation::WRPFSerbia => Some(Country::Serbia),
    ...
    pub fn sanctioning_body(self, date: Date) -> Option<Federation> {
        match self {
            ...
            Federation::WPLanka => Some(Federation::WP),
            ...
            Federation::WPPLKazakhstan => Some(Federation::WPPL),
            ...
            Federation::WRPFEurope => Some(Federation::WRPF),
            ...
            Federation::WRPFIndia => Some(Federation::WRPF),
            ...
            Federation::WRPFLatam => Some(Federation::WRPF),
            ...
            Federation::WRPFSerbia => Some(Federation::WRPF),
    ...
    pub fn default_points(self, date: Date) -> PointsSystem {
        match self {
            ...
            Federation::NZPU => PointsSystem::Dots,
            ...
            Federation::WPLanka => Federation::wp_rules_on(date),
            ...
            Federation::WPPLKazakhstan => PointsSystem::Wilks,
            ...
            Federation::WRPFEurope => PointsSystem::Wilks,
            ...
            Federation::WRPFSerbia => PointsSystem::Wilks,
