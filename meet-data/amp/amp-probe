...
#
# Probes for new Powerlifting America meets.
...
MEETSURL = "https://pa.liftingdatabase.com/competitions"
BASEURL = "https://pa.liftingdatabase.com/"
...
def main():
    ...
    oplprobe.print_meets(color('[AMP]'), unentered)
