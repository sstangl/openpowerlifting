...
URLS = ["http://www.nmaapowerlifting.com/results_all.aspx"]
BASEURL = "http://www.nmaapowerlifting.com"
...
def main():
    ...
    oplprobe.print_meets(color('[NMAA]'), unentered)
    print(color('[NMAA] ') + "Continue working through archive.")
