...
def parse_sheetname(s):
    ...
    s = s.replace('жимовое двоеборье', 'жимовое')
    ...
    for word in s.split():
        ...
        # Events
            ...
            assert not event
            event = 'S'
        elif word in ['жим', 'bp', 'bench', 'жд', 'жимовое']:
        ...
        elif word in ['spr', 'ultra', 'standart', 'стандарт', 'ультра', 'шоте',
                      'стандартдк', 'сандарт', 'станд', 'стандврт', 'жесткая', 'жест']:
            equipment = 'Multi-ply'
            event = 'B'
        ...
        # Booleans.
            ...
            amateur = 'Amateur'
        elif word == 'pro' or word == 'pro-' or word == 'профессионалы':
            assert amateur == 'Pro'
    ...
    for i in iterable:
        ...
        # Catch all for birthyear if this isn't a division-age column
            ...
            fieldnames.append('BirthYear')
                      ...
                      'собственнный вес', 'собственныйвес']:
            ...
            if header[i + 3].lower().replace('.', '') in ['рек', 'rec', 'sq4']:
                ...
                [next(iterable) for x in range(2)]
                      ...
                      'жим лёжа 1', 'жим лёжа 2', 'жим лёжа 3']:
...
def parse_sheet(sheet):
    ...
    if 'судейская' in title or 'судеская' in title or 'судьи' in title:
        return csv
    elif 'нж' in title or 'народный' in title or 'народн жим' in title:
    ...
    # Bench and then bench for reps
        ...
        return csv
    elif 'строгий' in title or 'бицепс' in title:  # curl
        return csv
