...
def parse_fieldnames(sheet):
    ...
    for i in iterable:
        ...
        elif text in ['весовая категория', 'в/к']:
        ...
        # This is the Wilks. But we prefer to re-calculate it ourselves.
                      ...
                      'вилкс', 'абс', 'абсолютное первенство', 'abs']:
            fieldnames.append('IGNORE')

        elif text == 'тренер':
            fieldnames.append('IGNORE')

        elif text in ['страна/клуб', 'town/region', 'регион']:
            fieldnames.append('IGNORE')
        elif text == 'страна':
