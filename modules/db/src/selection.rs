...
impl FromStr for AgeClassSelection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "over-y40" => Ok(AgeClassSelection::MastersOverY40),
            "over-y50" => Ok(AgeClassSelection::MastersOverY50),
            "over-y60" => Ok(AgeClassSelection::MastersOverY60),
...
impl FromStr for YearSelection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(YearSelection::OneYear(s.parse::<u16>()?))
    }
}
...
impl YearSelection {
    ...
    pub fn as_u32(self) -> Option<u32> {
        match self {
            ...
            YearSelection::OneYear(year) => Some(year as u32),
        }
    }
}
