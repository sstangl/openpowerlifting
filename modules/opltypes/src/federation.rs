...
impl Federation {
    ...
    pub fn default_points(self, date: Date) -> PointsSystem {
        match self {
            ...
            Federation::GPCAUS => PointsSystem::Reshel,
            Federation::GPCCAN => PointsSystem::Reshel,
            Federation::GPCGB => PointsSystem::Reshel,
            Federation::GPCIRL => PointsSystem::Reshel,
            Federation::GPCISR => PointsSystem::Reshel,
            Federation::GPCLAT => PointsSystem::Reshel,
            Federation::GPCNZ => PointsSystem::Reshel,
            Federation::GPCUKR => PointsSystem::Reshel,
            Federation::GPCUSA => PointsSystem::Reshel,
            Federation::GPCRUS => PointsSystem::Reshel,
