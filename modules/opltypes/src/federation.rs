...
impl Federation {
    ...
    pub fn sanctioning_body(self, date: Date) -> Option<Federation> {
        match self {
            ...
            Federation::ParaPL => None,
            // PA lost IPF affiliation in 2019.
            Federation::PA => if date.year() >= 2019 {
                Some(Federation::WP)
            } else {
                Some(Federation::IPF)
            },
            ...
            Federation::WP => None,
            Federation::WPA => None,
            Federation::WPARUS => None,
            Federation::WPAU => None,
            Federation::WPC => None,
            Federation::WPCFinland => None,
            Federation::WPCFrance => None,
            Federation::WPCGermany => None,
            Federation::WPCIceland => None,
            Federation::WPCKAZ => None,
            Federation::WPCKGZ => None,
            Federation::WPCLatvia => None,
            Federation::WPCMoldova => None,
            Federation::WPCPortugal => None,
            Federation::WPCRUS => None,
            Federation::WPCSA => None,
            Federation::WPCUKR => None,
            Federation::WPF => None,
            Federation::WPLeague => None,
            Federation::WPNZ => None,
