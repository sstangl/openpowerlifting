...
pub struct CountryTranslations {
    ...
    pub chinesetaipei: String,
    pub colombia: String,
    pub cotedivoire: String,
    pub czechia: String,
    pub czechrepublic: String,
    pub denmark: String,
    pub ecuador: String,
    pub egypt: String,
    pub england: String,
...
impl Translations {
    ...
    pub fn translate_country<'a>(&'a self, country: fields::Country) -> &'a str {
        match country {
            ...
            fields::Country::ChineseTaipei => &self.country.chinesetaipei,
            ...
            fields::Country::CzechRepublic => &self.country.czechrepublic,
