<select id="fedselect">
  ...
  <option value="AAU,ADFPA,AEP,AfricanPF,AsianPF,BP,CommonwealthPF,CPU,DSF,EPA,EPF,FEMEPO,FESUPO,FFForce,FPR,IDFPF,IPF,IrishPF,NAPF,NASA,NIPF,NSF,NZPF,OceaniaPF,ParaPL,PA,PLZS,PZKFiTS,RAW,ScottishPL,SVNL,THSPA,USAPL,WABDL,WDFPF,WelshPA,WNPF">
